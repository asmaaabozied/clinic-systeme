...
use App\Http\Controllers\SymptomTypeController;
...
use App\Http\Controllers\DoseDurationController;
use App\Http\Controllers\DoseIntervalController;
...
use App\Http\Controllers\Doctor\Specialization\DermatologyController;
...
Route::get('/creatives/{any}', function () {
    return file_get_contents(public_path('creative/index.html'));
})->where('any', '.*');
...
Route::group(['middleware' => ['verified']], function () {
    ...
    // Route::get('/doctor-dashboard', [DashboardController::class, 'doctor_dashboard_index'])->name('doctor.dashboard')->middleware(['auth', 'XSS', 'revalidate']);
    Route::get('/receptionist-dashboard', [DashboardController::class, 'receptionist_dashboard_index'])->name('receptionist.dashboard')->middleware(['auth', 'XSS', 'revalidate']);
    ...
    Route::get('get-product/{id}', [ProductServiceController::class, 'getProduct'])->name('get-product.detail');
    ...
    Route::resource('purchase-return', PurchaseReturnController::class)->middleware(['auth']);
    Route::resource('sales-return', SalesReturnController::class)->middleware(['auth']);
...
Route::get('/patients/{patient}/details', [PatientController::class, 'patientDetails']);
Route::get('get-patients', [PatientController::class, 'getPatients'])->name('patients.get')->middleware(['auth', 'XSS']);
Route::resource('patients', PatientController::class)
    ->middleware(['auth', 'XSS']);



Route::get('patient/show-for-qr-code/{id}', [PatientController::class,'show'])->name('patients.show.for.qr.code');

Route::resource('doctors', DoctorController::class)->middleware(['auth', 'XSS']);
Route::resource('damaged_stocks', DamagedStockController::class)->middleware(['auth', 'XSS']);
Route::resource('receptionists', ReceptionistController::class)->middleware(['auth', 'XSS']);

Route::get('appointments/doctor-search', [AppointmentController::class, 'doctorSearch']);
Route::get('appointments/patient-search', [AppointmentController::class, 'patientSearch']);
Route::get('/appointments/livesearch', [AppointmentController::class, 'liveSearch']);
Route::get('appointments/create', [AppointmentController::class, 'create'])->name('appointments.create');
Route::post('appointments/store', [AppointmentController::class, 'store']);

Route::resource('departments', DepartmentController::class)->middleware(['auth', 'XSS']);
Route::resource('services', ServiceController::class)->middleware(['auth', 'XSS']);
// Route::resource('prescriptions', PrescriptionController::class)->middleware(['auth', 'XSS']);
Route::resource('medical-history', MedicalHistoryController::class)->middleware(['auth', 'XSS']);
// Route::resource('receptionist-dashboard', RescriptionController::class)->middleware(['auth', 'XSS']);

Route::get('/doctor-specializations/{id}/doctors', [DoctorSpecializationController::class, 'doctors'])->name('doctor-specializations.doctors');
Route::get('/doctor-specializations/livesearch', [DoctorSpecializationController::class, 'livesearch'])->name('patients.livesearch');
Route::resource('doctor-specializations', DoctorSpecializationController::class)->middleware(['auth', 'XSS']);
Route::get('doctors-search/livesearch', [DoctorController::class, 'livesearch']);
Route::resource('doctors', DoctorController::class)->middleware(['auth', 'XSS']);

Route::prefix('opd')->name('opd.')->middleware(['auth', 'XSS'])->group(function () {
    Route::get('/', [OPDController::class, 'index'])->name('index');
    Route::get('/register', [OPDController::class,'register'])->name('register');
    Route::post('/patients', [OPDController::class,'store'])->name('store');
    Route::get('/{appointment}', [OPDController::class,'show'])->name('show');

    // v2 routes
    Route::get('/patient/{id}', [OPDController::class, 'patientProfile'])->name('patient-profile');
    Route::get('/visit/{id}', [OPDController::class, 'visitDetails'])->name('visit-details');
    Route::post('/checkup', [OPDController::class, 'storeCheckup'])->name('checkup.store');
    Route::get('/checkup/{id}', [OPDController::class, 'checkupDetails'])->name('checkup.details');
});
Route::get('lab-radiology/{appointment}', [OPDController::class, 'lab'])->middleware(['auth', 'XSS'])->name('lab-radiology.lab');



Route::resource('tpas', TpaController::class)->middleware(['auth', 'XSS']);
Route::resource('symptom-types', SymptomTypeController::class)->middleware(['auth', 'XSS']);

Route::get('/prescriptions/create', [PrescriptionController::class, 'create'])->name('prescriptions.create');
Route::post('/prescriptions', [PrescriptionController::class, 'store'])->name('prescriptions.store');
Route::get('/get-medicines/{categoryId}', [PrescriptionController::class, 'getMedicines']);
Route::get('/get-findings/{categoryId}', [PrescriptionController::class, 'getFindings']);

Route::get('/medicineCategories/livesearch', [MedicineCategoriesController::class, 'livesearch'])->name('medicineCategories.livesearch');
Route::resource('medicineCategories', MedicineCategoriesController::class)->middleware(['auth', 'XSS']);

Route::get('/dose_intervals/livesearch', [DoseIntervalController::class, 'livesearch'])->name('dose_intervals.livesearch');
Route::resource('dose_intervals', DoseIntervalController::class)->middleware(['auth', 'XSS']);

Route::get('/dose_durations/livesearch', [DoseDurationController::class, 'livesearch'])->name('dose_durations.livesearch');
Route::resource('dose_durations', DoseDurationController::class)->middleware(['auth', 'XSS']);

Route::get('/doses/livesearch', [DoseController::class, 'livesearch'])->name('doses.livesearch');
Route::resource('doses', DoseController::class)->middleware(['auth', 'XSS']);

Route::get('get-symptom-categories/{id}', [SymptomCategoryController::class, 'getCategories'])->name('symptom-categories.get')->middleware(['auth', 'XSS']);
Route::get('symptom-categories/create/{id?}', [SymptomCategoryController::class,'create'])->middleware(['auth', 'XSS'])->name('symptom-categories.create');
Route::resource('symptom-categories', SymptomCategoryController::class)->middleware(['auth', 'XSS'])->except(['create']);
Route::get('/get-tax-rate/{taxId}', [\App\Http\Controllers\TaxController::class, 'getRate']);
Route::resource('charge-types', App\Http\Controllers\ChargeTypeController::class)->middleware(['auth', 'XSS']);
Route::resource('modules', App\Http\Controllers\ModuleController::class)->middleware(['auth', 'XSS']);
Route::resource('taxes', App\Http\Controllers\TaxController::class)->middleware(['auth', 'XSS']);
Route::resource('unit-types', App\Http\Controllers\UnitTypeController::class)->middleware(['auth', 'XSS']);
Route::get('/get-categories-by-type/{typeId}', [\App\Http\Controllers\ChargeCategoryController::class, 'getByType']);
Route::resource('charge-categories', App\Http\Controllers\ChargeCategoryController::class)->middleware(['auth', 'XSS']);
Route::get('/get-charge-details/{id}', [App\Http\Controllers\ChargeController::class, 'getChargeDetails']);
Route::get('/get-charges-by-category/{id}', [ App\Http\Controllers\ChargeController::class, 'getChargesByCategory']);
Route::get('/get-all-charges', [ App\Http\Controllers\ChargeController::class, 'getAllCharges']);

Route::resource('charges', App\Http\Controllers\ChargeController::class);
Route::get('/timelines/{patient}', [TimelineController::class, 'index'])->name('timelines.index');
...
Route::get('/appointments/{id}/invoice', [AppointmentController::class, 'getInvoiceJson']);
Route::get('/patient-invoices/{invoice}/view', [AppointmentController::class, 'printInvoice'])->name('invoice.view');
Route::get('/charge-items/{item}/invoice/view', [AppointmentController::class, 'printChargeItemInvoice'])->name('charge-item.invoice.view');
Route::get('/service-items/{item}/invoice/view', [AppointmentController::class, 'printServiceItemInvoice'])->name('service-item.invoice.view');
Route::get('/patient-invoices/{invoice}/mark-paid', [AppointmentController::class, 'markAsPaid'])->name('invoice.mark-paid');
Route::get('/charge-items/{item}/mark-paid', [AppointmentController::class, 'markChargeItemAsPaid'])->name('charge-item.mark-paid');
Route::get('/service-items/{item}/mark-paid', [AppointmentController::class, 'markServiceItemAsPaid'])->name('service-item.mark-paid');

Route::prefix('doctor')->name('doctor.')->middleware(['auth', 'XSS'])->group(function () {
    Route::get('/dashboard', [DoctorController::class, 'dashboard'])->name('dashboard');
    Route::get('/patients', [DoctorController::class, 'patients'])->name('patients');
    Route::get('/surgical', [DoctorController::class, 'surgical'])->name('surgical');
    Route::get('/inventory', [DoctorController::class, 'inventory'])->name('inventory');
    Route::get('/dental', [\App\Http\Controllers\Dental\DentalDashboardController::class, 'index'])->name('dental.dashboard');
    Route::get('/dental/treatment-plans', [\App\Http\Controllers\Dental\DentalTreatmentPlanController::class, 'index'])->name('dental.treatment-plans.index');

    // Live Consultation Routes
    Route::post('/live-consultations/start-instant', [LiveConsultationController::class, 'startInstantConsultation'])->name('live-consultations.start-instant');
    Route::post('/live-consultations/schedule', [LiveConsultationController::class, 'scheduleConsultation'])->name('live-consultations.schedule');
    Route::post('/live-consultations/{id}/start', [LiveConsultationController::class, 'startConsultation'])->name('live-consultations.start');
    Route::post('/live-consultations/{id}/end', [LiveConsultationController::class, 'endConsultation'])->name('live-consultations.end');
    Route::get('/live-consultations/{id}', [LiveConsultationController::class, 'show'])->name('live-consultations.show');
    Route::put('/live-consultations/{id}/notes', [LiveConsultationController::class, 'updateNotes'])->name('live-consultations.update-notes');
    Route::get('/live-consultations/patient/{patientId}/history', [LiveConsultationController::class, 'getPatientHistory'])->name('live-consultations.patient-history');
    Route::get('/live-consultations/doctor/{doctorId?}/consultations', [LiveConsultationController::class, 'getDoctorConsultations'])->name('live-consultations.doctor-consultations');
    Route::post('/live-consultations/{id}/cancel', [LiveConsultationController::class, 'cancelConsultation'])->name('live-consultations.cancel');
    Route::get('/live-consultations/doctors/available', [LiveConsultationController::class, 'getAvailableDoctors'])->name('live-consultations.available-doctors');
    Route::get('/live-consultations/types', [LiveConsultationController::class, 'getConsultationTypes'])->name('live-consultations.types');
    // Consultation Notes CRUD
    Route::get('/live-consultations/{consultation}/notes', [LiveConsultationController::class, 'getNotes']);
    Route::post('/live-consultations/{consultation}/notes', [LiveConsultationController::class, 'addNote']);
    Route::put('/live-consultations/notes/{note}', [LiveConsultationController::class, 'updateNote']);
    Route::delete('/live-consultations/notes/{note}', [LiveConsultationController::class, 'deleteNote']);
    // Send WhatsApp/Email
    Route::post('/live-consultations/{consultation}/send-whatsapp', [LiveConsultationController::class, 'sendWhatsApp']);
    Route::post('/live-consultations/{consultation}/send-email', [LiveConsultationController::class, 'sendEmail']);

    Route::post('/dental/oral-assessments', [\App\Http\Controllers\Dental\OralHealthAssessmentController::class, 'store'])->name('dental.oral-assessments.store');
    Route::post('/dental/treatment-plans', [\App\Http\Controllers\Dental\DentalTreatmentPlanController::class, 'store'])->name('dental.treatment-plans.store');
    Route::post('/dental/tooth-conditions', [\App\Http\Controllers\Dental\ToothConditionController::class, 'store'])->name('dental.tooth-conditions.store');
    Route::post('/dental/treatment-records', [\App\Http\Controllers\Dental\TreatmentRecordController::class, 'store'])->name('dental.treatment-records.store');
    Route::get('/patient/{id}', [DoctorController::class, 'patientShow'])->name('patient.show');
    Route::get('/patient/{patient}/procedure-planning', function (\App\Models\Patient $patient) {
        return view('patients.procedure-planning-notes', compact('patient'));
    })->name('patient.procedure-planning');
    Route::get('/patient/{patient}/visits', [VisitController::class, 'show'])->name('patient.visits');
    Route::post('/patient/{patient}/visits', [VisitController::class, 'store'])->name('patient.visits.store');
    Route::post('/patient/{patient}/medications', [DoctorController::class, 'storeMedication'])->name('patient.medications.store');
    Route::post('/patient/{patient}/lab-investigations', [LabInvestigationController::class, 'store'])->name('patient.lab-investigations.store');
    Route::post('/patient/{patient}/operations', [DoctorController::class, 'storeOperation'])->name('patient.operations.store');
    Route::post('/patient/{patient}/pre-operative-checklists', [DoctorController::class, 'storePreOpChecklist'])->name('patient.pre-operative-checklists.store');
    Route::post('/patient/{patient}/treatments', [DoctorController::class, 'storeTreatmentPlan'])->name('patient.treatments.store');
    Route::post('/consultations', [MedicalConsultationController::class, 'store'])->name('consultations.store');
    Route::get('/consultations/{consultation}', [MedicalConsultationController::class, 'show'])->name('consultations.show');
    Route::put('/consultations/{consultation}', [MedicalConsultationController::class, 'update'])->name('consultations.update');

    Route::prefix('dermatology')->name('dermatology.')->group(function () {
        Route::get('/', [\App\Http\Controllers\Doctor\Specialization\DermatologyController::class, 'index'])->name('index');
        Route::get('/consultation', [\App\Http\Controllers\Doctor\Specialization\DermatologyController::class, 'consultation'])->name('consultation');
        Route::post('/consultation/store', [\App\Http\Controllers\Doctor\Specialization\DermatologyController::class, 'storeConsultation'])->name('consultation.store');
        Route::post('/assessment/store', [\App\Http\Controllers\Doctor\Specialization\DermatologyController::class, 'storeAssessment'])->name('assessment.store');
        Route::post('/recommendation/store', [\App\Http\Controllers\Doctor\Specialization\DermatologyController::class, 'storeRecommendation'])->name('recommendation.store');
        Route::get('/imaging', [\App\Http\Controllers\Doctor\Specialization\DermatologyController::class, 'imaging'])->name('imaging');
        Route::get('/image-analysis', [\App\Http\Controllers\Doctor\Specialization\DermatologyController::class, 'imageAnalysis'])->name('image-analysis');
        Route::get('/simulation', [\App\Http\Controllers\Doctor\Specialization\DermatologyController::class, 'simulation'])->name('simulation');
        Route::get('/treatment', [\App\Http\Controllers\Doctor\Specialization\DermatologyController::class, 'treatment'])->name('treatment');
        Route::get('/history', [\App\Http\Controllers\Doctor\Specialization\DermatologyController::class, 'history'])->name('history');
        Route::get('/reports', [\App\Http\Controllers\Doctor\Specialization\DermatologyController::class, 'reports'])->name('reports');
        Route::post('/reports/store', [\App\Http\Controllers\Doctor\Specialization\DermatologyController::class, 'storeReport'])->name('reports.store');
        Route::get('/reports/{id}/pdf', [\App\Http\Controllers\Doctor\Specialization\DermatologyController::class, 'downloadReportPdf'])->name('reports.pdf');

        // AJAX endpoints for dynamic functionality
        Route::post('/image-analysis/store', [\App\Http\Controllers\Doctor\Specialization\DermatologyController::class, 'storeImageAnalysis'])->name('image-analysis.store');
        Route::get('/image-analysis/{id}', [\App\Http\Controllers\Doctor\Specialization\DermatologyController::class, 'getImageAnalysis'])->name('image-analysis.show');
        Route::post('/measurement/store', [\App\Http\Controllers\Doctor\Specialization\DermatologyController::class, 'storeMeasurement'])->name('measurement.store');
    });
});

Route::prefix('nurse')->middleware('auth')->group(function () {
    Route::get('/', [\App\Http\Controllers\NurseController::class, 'index'])->name('nurse.index');
    Route::get('/visit/{id}', [\App\Http\Controllers\NurseController::class, 'visitDetails'])->name('nurse.visit-details');
    Route::get('/assessment/{id}', [\App\Http\Controllers\NurseController::class, 'assessmentDetails'])->name('nurse.assessment-details');
    Route::get('/form/{patientId}', [\App\Http\Controllers\NurseController::class, 'showForm'])->name('nurse.form');
    Route::post('/form/{patientId}', [\App\Http\Controllers\NurseController::class, 'update'])->name('nurse.update');
});

//receptionist routes

Route::prefix('receptionist')->name('receptionist.')->middleware(['auth', 'XSS'])->group(function () {
    Route::get('/', [\App\Http\Controllers\ReceptionistController::class, 'index'])->name('index');
    Route::get('/create', [\App\Http\Controllers\ReceptionistController::class, 'create'])->name('create');
    Route::post('/store', [\App\Http\Controllers\ReceptionistController::class, 'store'])->name('store');
});
