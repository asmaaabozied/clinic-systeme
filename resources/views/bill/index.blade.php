                                        ...
                                        <td class="Action">
                                            <span>
                                                ...
                                                @endcan
                                                    ...
                                                    @php  $product=\App\Models\BillProduct::where('bill_id',$bill->id)->first()->product_id;
                                                            $dat=\App\Models\PurchaseReturn::where('product_id',$product)->first()->id ?? null;
                                                ...
                                                @can('edit bill')
                                                    <div class="action-btn me-2">
                                                        @if(!empty($dat))
                                                        <a href="{{ route('purchase-return.edit',$dat) }}" class="mx-3 btn btn-sm align-items-center bg-info" data-bs-toggle="tooltip" title="Edit" data-original-title="{{__('Edit')}}">
                                                            <i class="ti ti-book text-white"></i>
                                                        </a>
                                                        @else
                                                            <a href="{{ route('purchase-return.index') }}" class="mx-3 btn btn-sm align-items-center bg-info" data-bs-toggle="tooltip" title="Edit" data-original-title="{{__('Edit')}}">
                                                            <i class="ti ti-book text-white"></i>
                                                        </a>
                                                        @endif
                                                    </div>
