                        ...
                        <div class="row d-flex align-items-center justify-content-end">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                                <div class="btn-box">
                                    ...
                                    {{ Form::select('type',[''=>'Select Type','Sales'=>'Sales','Purchase'=>'Purchase'],'', ['class' => 'form-control select']) }}
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mr-2">
                                    <div class="btn-box">
                                                ...
                                                @php $invoiceID= Crypt::encrypt($invoice->id); @endphp
                                                    ...
                                                    @can('show invoice')
                                                        ...
                                                        <div class="action-btn me-2">
                                                            ...
                                                            @php  $product=\App\Models\InvoiceProduct::where('invoice_id',$invoice->id)->first()->product_id ?? null;
                                                            $dat=\App\Models\PurchaseReturn::where('product_id',$product)->first()->id ?? null;

                                                             @endphp

                                                            @if(!empty($dat))
                                                                    <a href="{{ route('sales-return.edit', $dat) }}"
                                                                       class="mx-3 btn btn-sm align-items-center bg-warning" data-bs-toggle="tooltip" title="Sales Return"
                                                                       data-original-title="{{ __('Sales Return') }}">
