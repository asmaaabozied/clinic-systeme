                                            ...
                                            <span>
                                                ...
                                                @can('edit purchase')
                                                    ...
                                                    <div class="action-btn me-2">
                                                           ...
                                                           @php  $productid=\App\Models\PurchaseProduct::where('purchase_id',$purchase->id)->first()->product_id;
$id=\App\Models\PurchaseReturn::where('product_id',$productid)->first()->id ?? null;
                                                           @endphp
                                                        @if(!empty($id))
                                                        <a href="{{ route('purchase-return.edit',$id) }}"
                                                           class="mx-3 btn btn-sm align-items-center bg-info"
                                                           data-bs-toggle="tooltip" title="Purchase Return"
                                                           data-original-title="{{__('Purchase')}}">
