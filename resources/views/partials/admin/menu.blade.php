                ...
                <div class="navbar-wrapper">
                    <div class="m-header main-logo">
                        <a href="#" class="b-brand">
                            ...
                            @if ($setting['cust_darklayout'] && $setting['cust_darklayout'] == 'on')
                                ...
                                <img  src="{{ $company_logos ? display_file($company_logos) : '' }}" alt="Avatar" class="logo logo-lg">
                            @else
                                {{-- <img src="{{ $logo . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-light.png') . '?' . time() }}"
                                    alt="{{ config('app.name', 'ERPGo-SaaS') }}" class="logo logo-lg"> --}}
                                <img  src="{{ $company_logo ? display_file($company_logo) : '' }}" alt="Avatar" class="logo logo-lg">
                            @endif
                                                ...
                                                @if (Gate::check('manage customer') ||
                                                    ...
                                                    <li
                                                        ...
                                                        <ul class="dash-submenu">
                                                            ...
                                                            @can('manage invoice')
                                                                <li
                                                                    class="dash-item {{ Request::route()->getName() == 'sales-return.index' || Request::route()->getName() == 'sales-return.create' || Request::route()->getName() == 'sales-return.edit' ? ' active' : '' }}">
                                                                    <a class="dash-link"
                                                        ...
                                                        <ul class="dash-submenu">
                                                            ...
                                                            @can('manage bill')
                                                                <li
                                                                    ...
                                                                    <li
                                                                    class="dash-item {{ Request::route()->getName() == 'purchase-return.index' || Request::route()->getName() == 'purchase-return.create' || Request::route()->getName() == 'purchase-return.edit' ? ' active' : '' }}">
                                                                    <a class="dash-link"
                        ...
                        Request::segment(1) == 'userlogs'
                            ...
                            : '' }}">
                                        ...
                                        <ul class="dash-submenu">
                                            ...
                                            @can('manage doctors')
                                                <li
                                                    class="dash-item {{ Request::route()->getName() == 'doctors.index' || Request::segment(1) == 'doctors' || Request::route()->getName() == 'doctors.edit' ? ' active' : '' }}">
                                                    <a class="dash-link" href="{{ route('doctors.index') }}">{{ __('Doctor') }}</a>
                                                </li>
                                            @endcan
                                        </ul>
                                    </li>
                            ...
                            <!--------------------- End User Managaement System----------------------------------->
                                ...
                                @if (!empty($userPlan) && $userPlan->medicine == 1)
                                    @if (Auth::user()->type != 'super admin')
                                        <li class="dash-item dash-hasmenu {{ in_array(Request::segment(1), ['users', 'roles', 'clients', 'userlogs']) ? 'active dash-trigger' : '' }}">
                                            <a href="#" class="dash-link">
                                                <span class="dash-micon"><i class="ti ti-users"></i></span>
                                                <span class="dash-mtext" style="font-size: smaller;">{{ __('Medical Management') }}</span>
                                                <span class="dash-arrow"><i data-feather="chevron-right"></i></span>
                                            </a>
                                            <ul class="dash-submenu">
                                                @can('manage doctor specializations')
                                                    <li class="dash-item {{ in_array(Request::route()->getName(), ['doctor_specializations.index','doctor_specializations.create','doctor_specializations.edit','user.userlog']) ? 'active' : '' }}">
                                                        <a class="dash-link" href="{{ route('doctor-specializations.index') }}">
                                                            {{ __('Specializations') }}
                                                        </a>
                                                    </li>
                                                @endcan
                                                @can('manage medicine categories')
                                                    <li class="dash-item {{ in_array(Request::route()->getName(), ['medicineCategories.index','medicineCategories.create','medicineCategories.edit','user.userlog']) ? 'active' : '' }}">
                                                        <a class="dash-link" href="{{ route('medicineCategories.index') }}">
                                                            {{ __('MedicineCategory') }}
                                                        </a>
                                                    </li>
                                                @endcan
                                                @can('manage doses')
                                                    <li class="dash-item {{ in_array(Request::route()->getName(), ['doses.index','doses.create','doses.edit','user.userlog']) ? 'active' : '' }}">
                                                        <a class="dash-link" href="{{ route('doses.index') }}">
                                                            {{ __('Doses') }}
                                                        </a>
                                                    </li>
                                                @endcan
                                                @can('manage dose intervals')
                                                    <li class="dash-item {{ in_array(Request::route()->getName(), ['dose_intervals.index','dose_intervals.create','dose_intervals.edit','user.userlog']) ? 'active' : '' }}">
                                                        <a class="dash-link" href="{{ route('dose_intervals.index') }}">
                                                            {{ __('Dose Intervals') }}
                                                        </a>
                                                    </li>
                                                @endcan
                                                @can('manage dose durations')
                                                    <li class="dash-item {{ in_array(Request::route()->getName(), ['dose_durations.index','dose_durations.create','dose_durations.edit','user.userlog']) ? 'active' : '' }}">
                                                        <a class="dash-link" href="{{ route('dose_durations.index') }}">
                                                            {{ __('Dose Durations') }}
                                                        </a>
                                                    </li>
                                                @endcan
                                                @can('manage patients')
                                                    <li class="dash-item {{ Request::route()->getName() == 'patients.index' || Request::route()->getName() == 'patients.create' || Request::route()->getName() == 'patients.edit' || Request::route()->getName() == 'user.userlog' ? ' active' : '' }}">
                                                        <a class="dash-link" href="{{ route('patients.index') }}">{{ __('Patient') }}</a>
                                                    </li>
                                                @endcan
                                                @can('create checkups')
                                                    <li class="dash-item {{ Request::route()->getName() == 'opd.index' ? 'active' : '' }}">
                                                        <a class="dash-link" href="{{ route('opd.index') }}">{{ __('OPD - Out Patient') }}</a>
                                                    </li>
                                                @endcan
                                                @can('manage charge types')
                                                    <li class="dash-item {{ Request::route()->getName() == 'charge-types.index' ? 'active' : '' }}">
                                                        <a class="dash-link" href="/charge-types">{{ __('Charge Types') }}</a>
                                                    </li>
                                                @endcan
                                                @can('manage modules')
                                                    <li class="dash-item {{ Request::route()->getName() == 'modules.index' ? 'active' : '' }}">
                                                        <a class="dash-link" href="/modules">{{ __('Modules') }}</a>
                                                    </li>
                                                @endcan
                                                @can('manage taxes')
                                                    <li class="dash-item {{ Request::route()->getName() == 'taxes.index' ? 'active' : '' }}">
                                                        <a class="dash-link" href="/taxes">{{ __('Taxes') }}</a>
                                                    </li>
                                                @endcan
                                                @can('manage unit types')
                                                    <li class="dash-item {{ Request::route()->getName() == 'unit-types.index' ? 'active' : '' }}">
                                                        <a class="dash-link" href="/unit-types">{{ __('Unit Types') }}</a>
                                                    </li>
                                                @endcan
                                                @can('manage charge categories')
                                                    <li class="dash-item {{ Request::route()->getName() == 'charge-categories.index' ? 'active' : '' }}">
                                                        <a class="dash-link" href="/charge-categories">{{ __('Charge Categories') }}</a>
                                                    </li>
                                                @endcan
                                                @can('manage charges')
                                                    <li class="dash-item {{ Request::route()->getName() == 'charges.index' ? 'active' : '' }}">
                                                        <a class="dash-link" href="/charges">{{ __('Charges') }}</a>
                                                    </li>
                                                @endcan
                                                <li class="dash-item {{ Request::route()->getName() == 'nurse.index' ? 'active' : '' }}">
                                                    <a class="dash-link" href="/nurse">{{ __('Nurse') }}</a>
                                                </li>
                                            </ul>
                                        </li>
                                    @endif
                                ...
                                <i data-feather="chevron-right"></i></span>
                                        ...
                                        <ul class="dash-submenu">
                                            @if (Gate::check('manage product & service'))
                                                ...
                                                </li>      <li class="dash-item {{ Request::segment(1) == 'brands' ? 'active' : '' }}">
                                                    <a href="{{ route('brands.index') }}"
                                                       class="dash-link">{{ __('Brands') }}
                                                    </a>
                                                </li>
                                ...
                                @if (!empty($userPlan) && $userPlan->pos == 1)
                                    @if (Gate::check('manage warehouse') ||
                                        ...
                                        <li
                                            ...
                                            <a href="#!" class="dash-link"><span class="dash-micon"><i
                                                        class="ti ti-layers-difference"></i></span><span
                                                    class="dash-mtext">{{ __('Purchase and Inventory') }}</span><span class="dash-arrow"><i
                                                        data-feather="chevron-right"></i></span></a>
                                            <ul
                                ...
                                Request::route()->getName() == 'pos.show'
                                    ...
                                    : '' }}">
                                                @can('manage warehouse')
                                                    ...
                                                    <li
                                                        class="dash-item {{ Request::route()->getName() == 'damaged_stocks.index' || Request::route()->getName() == 'damaged_stocks.show' ? ' active' : '' }}">
                                                        <a class="dash-link" href="{{ route('damaged_stocks.index') }}">{{ __('Damaged Stocks') }}</a>
                                                    </li>
                                                @endcan
                                                @can('manage purchase')
                                                    <li
                    ...
                    <!--------------------- Start clinc ----------------------------------->
                        <ul class="sidebar-menu">
                            ...
                            {{-- @if (Auth::check())
                                @php
                                    $userType = Auth::user()->type;  // doctor أو receptionist
                                @endphp

                                @if ($userType == 'doctor' || $userType == 'receptionist')
                                    <li class="menu-item has-submenu {{ request()->is('clinc*') ? 'active' : '' }}">
                                        <a href="javascript:void(0);" class="menu-link">
                                            <i class="icon ti ti-users"></i>
                                            <span>Clinc</span>
                                            <i class="submenu-arrow ti ti-chevron-right"></i>
                                        </a>
                                        <ul class="submenu">

                                            @if ($userType == 'doctor')
                                                <li class="{{ request()->is('clinc/my-patients') ? 'active' : '' }}">
                                                    <a href="{{ route('doctor.patients') }}">My Patients</a>
                                                </li>
                                            @elseif ($userType == 'receptionist')
                                                <li class="{{ request()->is('clinc/patients') ? 'active' : '' }}">
                                                    <a href="{{ route('receptionist.patients') }}">Patients</a>
                                                </li>
                                                <li class="{{ request()->is('clinc/patients/create') ? 'active' : '' }}">
                                                    <a href="{{ route('receptionist.patients.create') }}">Add Patient</a>
                                                </li>
                                            @endif
