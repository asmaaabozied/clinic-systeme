                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    {{Form::label('phone',__('Phone'),array('class'=>'form-label')) }}<x-required></x-required>
                                    {{Form::text('phone',null,array('class'=>'form-control' , 'required'=>'required' ,'placeholder'=>__('Enter employee phone')))}}
                                </div>
