            ...
            <div class="modal-content">
                <div class="modal-header bg-behance ">
                    <div class="d-flex align-items-center gap-2">
                        <div>
                            <h3>
                                <i class="fas fa-stethoscope"></i> New Visit for {{ $patient->name ?? 'New Patient' }}
                            </h3>
                        </div>
...
{{--                                        <input type="text" class="form-control" id="case" name="case">--}}
                    ...
                    <div class="modal-footer mt-4">
                        <button type="button" id="saveAndPrint" class="btn btn-secondary bg-behance border-body" data-bs-dismiss="modal">
            ...
            <div class="modal-body">
                <form id="patientForm" enctype="multipart/form-data" onsubmit="event.preventDefault();">
                    ...
                    <div class="row mb-3">
                        ...
                        <div>
                            <button type="submit"
                                    class="btn btn-primary w-25 float-end mt-4  bg-behance border-0 ">Save
                            </button>
...
<div class="modal fade" id="prescriptionModal" tabindex="-1" aria-labelledby="prescriptionModalLabel"
    ...
    <div class="modal-dialog modal-fullscreen modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <script>
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    ...
                    fetch(`/get-all-charges`)
                        ...
                        .then(data => {
                            const choicesArray = data.map(charge => ({
                                value: charge.id,
                                label: charge.charge_name + ' - code#' + charge.code
                            }));
                    ...
                    function attachCalc(row) {
                        ...
                        const taxValue = row.querySelector('.tax');
                    ...
                    if (saveAndPrintBtn) {
                        saveAndPrintBtn.addEventListener('click', function () {
                            ...
                            fetch('/appointments/store', {
                                ...
                                .then(response => {
                                    bootstrap.Modal.getInstance(document.getElementById('fullScreenModal')).hide();
                                    window.open('/patient-invoices/' + response.invoice_id + '/view', '_blank');
                                })
                                .catch(error => {
                                    if (error.errors) {
                                        showErrors(error.errors);
            ...
            <script>
                function openOpdModal(patientId) {
