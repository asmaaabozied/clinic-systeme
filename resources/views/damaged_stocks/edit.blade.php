{{ Form::model($data, array('route' => array('damaged_stocks.update', $data->id), 'method' => 'PUT', 'class'=>'needs-validation', 'novalidate')) }}
...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            {{Form::label('number',__('Reference number'),array('class'=>'form-label')) }}<x-required></x-required>
            {{Form::text('number',null,array('class'=>'form-control','rows'=>3 ,'required'=>'required', 'placeholder' => __('Enter Reference number')))}}
        </div>
        <div class="form-group col-md-6">
            {{Form::label('total',__('Total'),array('class'=>'form-label')) }}<x-required></x-required>
        ...
        <div class="form-group col-md-6">
            {{Form::label('description',__('Reason'),array('class'=>'form-label')) }}<x-required></x-required>
