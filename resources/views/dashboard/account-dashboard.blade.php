                ...
                <div class="col-xxl-7">
                    <div class="row gy-4 mb-4 dash-row">
                        <div class="col-sm-6 col-12 dash-info-card">
                            <div class="info-card-inner card mb-0 bg-white">
                                ...
                                <div class="info-content">
                                    <h2 class="h4 mb-0"><a href="{{ route('customer.index') }}"
                                            class="info-link dashboard-link">Total Patients</a></h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-12 dash-info-card">
                            <div class="info-card-inner card mb-0 bg-white">
                                ...
                                <div class="info-content">
                                    <h2 class="h4 mb-0"><a href="{{ route('vender.index') }}"
                                            class="info-link dashboard-link">Total Doctors</a></h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-12 dash-info-card">
                            ...
                            <div class="info-card-inner card mb-0 bg-white">
                                ...
                                <div class="info-content">
                                    <h2 class="h4 mb-0"><a href="{{ route('bill.index') }}"
                                            class="info-link dashboard-link">Total Appointments</a></h2>
                                </div>
                            </div>
                        </div>
                    </div>
