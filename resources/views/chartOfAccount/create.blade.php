...
<div class="modal-body">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-12">
            ...
            {{ Form::text('name', '', ['class' => 'form-control', 'required' => 'required' , 'placeholder'=>__('Enter Name In English')]) }}
        </div>
        <div class="form-group col-md-12">
            {{ Form::label('name_ar', __('Name Ar'), ['class' => 'form-label']) }}<x-required></x-required>
            {{ Form::text('name_ar', '', ['class' => 'form-control', 'required' => 'required' , 'placeholder'=>__('Enter Name In Arabic')]) }}
        </div>
