    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <ul class="nav nav-pills mb-0" id="pills-tab" role="tablist">
                ...
                @if (!empty($userPlan) && $userPlan->pos == 1)
                    <li class="nav-item">
                        <a class="nav-link" id="pills-account-tab" data-bs-toggle="pill" href="#clinic" role="tab" aria-controls="pills-contact" aria-selected="false">{{__('Medical')}}</a>
                    </li>
                @endif
            ...
            <div class="tab-content" id="pills-tabContent">
                 ...
                 <div class="tab-pane fade" id="clinic" role="tabpanel" aria-labelledby="pills-home-tab">
                     <input type="hidden" name="module" value="clinic">

                     @php
                        $modules=['clinic dashboard','medical dashboard','doctor','doctor dashboard','receptionist','patient','appointment' ,'doctor specializations'];
                        // ,'appointment','prescription','medical history','medical report','medical invoice','medical bill'
                        ...
                        <div class="form-group">
                            @if(!empty($permissions))
                                ...
                                <table class="table table-striped mb-0" id="">
                                    ...
                                    <tr>
                                        <th>
                                            <input type="checkbox" class="form-check-input align-middle custom_align_middle" name="clinic_checkall" id="clinic_checkall" >
                                        </th>
                                        <th>{{__('Module')}} </th>
                                    ...
                                    @foreach($modules as $module)
                                        <tr>
                                            <td><input type="checkbox" class="form-check-input align-middle ischeck clinic_checkall"  data-id="{{str_replace(' ', '', str_replace('&', '', $module))}}" ></td>
                                            <td><label class="ischeck clinic_checkall" data-id="{{str_replace(' ', '', str_replace('&', '', $module))}}">{{ ucfirst($module) }}</label></td>
                                            <td>
                                                    ...
                                                    @if(in_array('manage '.$module,(array) $permissions))
                                                        @if($key = array_search('manage '.$module,$permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,$role->permission, ['class'=>'form-check-input clinic_checkall isscheck_'.str_replace(' ', '', str_replace('&', '', $module)),'id' =>'permission'.$key])}}
...
<script>
    $(document).ready(function () {
        $("#clinic_checkall").click(function(){
            $('.clinic_checkall').not(this).prop('checked', this.checked);
        });
