        ...
        <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade" id="clinic" role="tabpanel" aria-labelledby="pills-home-tab">
                    ...
                    @php
//                        $modules=['doctor','doctor dashboard','receptionist','patient','appointment' ,'doctor specializations', 'Medicine category','doses','dose interval'];
                                                    ...
                                                    @if(in_array('manage '.$module,(array) $permissions))
                                                        @if($key = array_search('manage '.$module,$permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,false, ['class'=>'form-check-input clinic_checkall isscheck_'.str_replace(' ', '', str_replace('&', '', $module)),'id' =>'permission'.$key])}}
