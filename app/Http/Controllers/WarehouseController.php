...
class WarehouseController extends Controller
{
    ...
    public function index()
    {
        ...
        $warehouses = warehouse::where('created_by', '=', \Auth::user()->creatorId())->latest()->get();
    ...
    {
        $doctors = User::where('type', 'doctor')->get()->pluck('name', 'id');
        $doctors->prepend('Select Doctor', '');

        return view('warehouse.create', compact('doctors'));
    ...
    public function store(Request $request)
    {
        if (\Auth::user()->can('create warehouse')) {
            ...
            $warehouse->doctor_id = $request->doctor_id;
            $warehouse->city = 0;
            $warehouse->city_zip = 0;
    ...
    public function edit(warehouse $warehouse)
    {
        ...
        if (\Auth::user()->can('edit warehouse')) {
            if ($warehouse->created_by == \Auth::user()->creatorId()) {
                ...
                $doctors = User::where('type', 'doctor')->get()->pluck('name', 'id');
                $doctors->prepend('Select Doctor', '');
                return view('warehouse.edit', compact('warehouse', 'doctors'));
            } else {
