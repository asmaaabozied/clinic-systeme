...
class PurchaseReturnController extends Controller
{
    public function index(Request $request)
    {
        ...
        if (\Auth::user()->can('manage product & service')) {
            $data = PurchaseReturn::where('type', 'Purchase')->get();
...
//        if (\Auth::user()->can('create purchase')) {
        ...
        return view('purchase-return.create', compact('products', 'branch', 'vendor'));
...
//        }
    ...
    public function store(Request $request)
    {
        if (\Auth::user()->can('create purchase')) {
            ...
            return redirect()->route('purchase-return.index')->with('success', __('Purchase Return successfully created.'));
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
...
//                return redirect()->route('purchase-return.index')->with('success', __('Purchase Return successfully updated.'));
        return redirect()->back()->with('success', __('Purchase Return successfully updated.'));
//            } else {
//                return redirect()->back()->with('error', __('Permission denied.'));
//            }
    }
    ...
    public function destroy($id)
    {
        if (\Auth::user()->can('delete purchase')) {
            $data = PurchaseReturn::find($id);
            $data->delete();
            return redirect()->route('purchase-return.index')->with('success', __('Purchase Return successfully deleted.'));
