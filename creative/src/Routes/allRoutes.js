...
import SpecializationsIndex from '../pages/Medical/Specializations/Index';
import SpecializationDoctors from '../pages/Medical/Specializations/Doctors';
import SpecializationsDataTable from '../pages/Medical/SpecializationsDataTable';
import MedicineCategoriesIndex from '../pages/Medical/MedicineCategories/Index';
import MedicineCategoriesDataTable from '../pages/Medical/MedicineCategoriesDataTable';
import DosesIndex from '../pages/Medical/Doses/Index';
import DosesDataTable from '../pages/Medical/DosesDataTable';
import DoseIntervalsIndex from '../pages/Medical/DoseIntervals/Index';
import DoseIntervalsDataTable from '../pages/Medical/DoseIntervalsDataTable';
import PatientsDataTable from '../pages/OPD/PatientsDataTable';
...
const authProtectedRoutes = [
  ...
  { path: "/medical/specializations", component: <SpecializationsIndex /> },
  { path: "/medical/specializations/:id/doctors", component: <SpecializationDoctors /> },
  { path: "/medical/specializations-datatable", component: <SpecializationsDataTable /> },
  { path: "/medical/medicine-categories", component: <MedicineCategoriesIndex /> },
  { path: "/medical/medicine-categories-datatable", component: <MedicineCategoriesDataTable /> },
  { path: "/medical/doses", component: <DosesIndex /> },
  { path: "/medical/doses-datatable", component: <DosesDataTable /> },
      { path: "/medical/dose-intervals", component: <DoseIntervalsIndex /> },
    { path: "/medical/dose-intervals-datatable", component: <DoseIntervalsDataTable /> },
    { path: "/opd/patients-datatable", component: <PatientsDataTable /> },
